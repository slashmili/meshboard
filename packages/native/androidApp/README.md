...
`emulator`, `run`, `build`, `test`, `interop`, and `crdt-test`. Start the emulator once, then
...
without the optional library. Live Android CRDT transport is the next checkpoint.
